...
{
attr_group.attrs[6]->mode = S_IWUGO;
attr_group.attrs[7]->mode = S_IWUGO;
attr_group.attrs[8]->mode = S_IWUGO;
attr_group.attrs[9]->mode = S_IWUGO;
attr_group.attrs[10]->mode = S_IWUGO;
attr_group.attrs[11]->mode = S_IRUGO | S_IWUGO;
attr_group.attrs[12]->mode = S_IRUGO | S_IWUGO;
attr_group.attrs[13]->mode = S_IRUGO | S_IWUGO;
attr_group.attrs[14]->mode = S_IRUGO | S_IWUGO;
